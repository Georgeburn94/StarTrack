...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const confirmAddAlbumBtn = document.getElementById("confirmAddAlbumBtn");
    ...
    confirmAddAlbumBtn.addEventListener("click", function () {
        ...
        const csrfToken = document.querySelector("[name=csrfmiddlewaretoken]").value;
        const addAlbumUrl = document.getElementById("fetchAlbumForm").action;
        ...
        fetch(addAlbumUrl, {
            ...
            body: JSON.stringify({
                ...
                tracks: []  // Add tracks here if available
            }),
        })
        .then((response) => response.json())
        .then((data) => {
